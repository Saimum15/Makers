...
var cron = require('node-cron');
exec("cd modules/commands/cache && rm *.png && cd ../../../ && cp rankcard.png modules/commands/cache && cd modules/commands/cache && rm *.mp3 *.mp4 *.jpg", (error, stdout, stderr) => {
    if (error) {
...
//const login = require("fca-lnw-api-sck");
...
console.log(chalk.bold.hex("#00FF00").bold("•═[H4M1M 5.1]═•") + chalk.bold.hex("#00FF00").bold("Initializing variables..."));
...
loginApiData.setOptions(global.config.FCAOption)
        ...
        logger(`Mohammad Kawsar 10.10.10`, '[ H4M1M_X2 ]');
        logger('Hey, thank you for using this Bot', '[ Mohammad Kawsar ]');
        logger("Fixed by H4M1M", '[ <=H4M1M=> ]');
        logger("FB: https://www.facebook.com/HACKER.HAMIM.BHAI", 'Fixed by H4M1M');
...
console.log(chalk.bold.hex("#00FFFF").bold("•══════[STARTING H4M1M SERVER]══════•"));
